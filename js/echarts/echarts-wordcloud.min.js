!function (t, e) {
    ...
    return function (t) {
        ...
        }, R = Object.prototype.toString, O = Array.prototype, z = O.forEach, L = O.filter, D = O.slice, q = O.map, j = O.reduce, W = {
            inherits: f,
            mixin: h,
            clone: n,
            merge: a,
        ...
        function l(t, e) {
            ...
            var r = h.parseDate(e), n = r.getFullYear(), a = r.getMonth() + 1, i = r.getDate(), o = r.getHours(), u = r.getMinutes(), c = r.getSeconds();
        ...
        var a = r(1), i = r(7), o = r(3), u = r(5), c = o.parsePercent, l = a.each, s = {}, f = ["left", "right", "top", "bottom", "width", "height"];
        s.box = n, s.vbox = a.curry(n, "vertical"), s.hbox = a.curry(n, "horizontal"), s.getAvailableSize = function (t, e, r) {
            ...
            var n = e.width, a = e.height, o = c(t.left, n), l = c(t.top, a), s = c(t.right, n), f = c(t.bottom, a), h = c(t.width, n), d = c(t.height, a), g = r[2] + r[0], m = r[1] + r[3], p = t.aspect;
        ...
        n.prototype = {
            constructor: n, union: function (t) {
                ...
                var e = this, r = e.x, n = e.x + e.width, a = e.y, i = e.y + e.height, o = t.x, u = t.x + t.width, c = t.y, l = t.y + t.height;
        ...
        var r = "undefined" == typeof Float32Array ? Array : Float32Array, n = {
            create: function () {
                ...
                var n = e[0] * r[0] + e[2] * r[1], a = e[1] * r[0] + e[3] * r[1], i = e[0] * r[2] + e[2] * r[3], o = e[1] * r[2] + e[3] * r[3], u = e[0] * r[4] + e[2] * r[5] + e[4], c = e[1] * r[4] + e[3] * r[5] + e[5];
        ...
        a.extendChartView({
            type: "wordCloud", render: function (t, e, r) {
                ...
                t.layoutInstance.ondraw = function (t, e, r, c) {
                    var l = o.getItemModel(r), s = l.getModel("textStyle.normal"), f = l.getModel("textStyle.emphasis"), h = function (t, r) {
        ...
        window.setImmediate || (window.setImmediate = function () {
            ...
            var i = function () {
                ...
                if (i) {
                    ...
                    var l, s, f, h, d, g, m, p = n.gridSize, v = p - n.maskGapWidth, y = Math.abs(n.maxRotation - n.minRotation), w = Math.min(n.maxRotation, n.minRotation), x = n.rotationStep;
                    switch (n.color) {
                        case"random-dark":
                            m = function () {
                                return r(10, 50)
                    ...
                    var b, S = !1, C = [], I = function (t) {
                        ...
                        var i = e - a.left, o = r - a.top, u = Math.floor(i * (n.width / a.width || 1) / p), c = Math.floor(o * (n.height / a.height || 1) / p);
                        return C[u][c]
                    }, T = function (t) {
                        var e = I(t);
                        ...
                        var s = l.measureText(t).width / u, f = Math.max(i * u, l.measureText("m").width, l.measureText("Ｗ").width) / u, h = s + 2 * f, d = 3 * f, g = Math.ceil(h / p), m = Math.ceil(d / p);
                        h = g * p, d = m * p;
                        var v = -s / 2, y = .4 * -f, w = Math.ceil((h * Math.abs(Math.sin(r)) + d * Math.abs(Math.cos(r))) / p), x = Math.ceil((h * Math.abs(Math.cos(r)) + d * Math.abs(Math.sin(r))) / p), M = x * p, b = w * p;
        ...
        a.registerLayout(function (t, e) {
            t.eachSeriesByType("wordCloud", function (r) {
                var u = i.getLayoutRect(r.getBoxLayoutParams(), {
                    width: e.getWidth(),
                    height: e.getHeight()
                ...
                var d = r.get("sizeRange"), g = r.get("rotationRange"), m = c.getDataExtent("value"), p = Math.PI / 180, v = r.get("gridSize");
                o(l, {
